  ...
  const services = [
    {
      ...
      icon: <svg className="w-16 h-16 p-1 -mt-1 mb-2" viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg">
        <g fill="none" fillRule="evenodd">
          ...
          <g strokeWidth="2">
            <path className="stroke-current text-violet-300" d="M34.514 35.429l2.057 2.285h8M20.571 26.286h5.715l2.057 2.285" />
            <path className="stroke-current text-white" d="M20.571 37.714h5.715L36.57 26.286h8" />
            <path className="stroke-current text-violet-300" strokeLinecap="square" d="M41.143 34.286l3.428 3.428-3.428 3.429" />
      ...
      icon: <svg className="w-16 h-16 p-1 -mt-1 mb-2" viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg">
        <g fill="none" fillRule="evenodd">
          ...
          <g strokeWidth="2" transform="translate(19.429 20.571)">
            ...
            <path className="stroke-current text-violet-300" d="M16.161 18.406a6.848 6.848 0 003.268-5.835 6.857 6.857 0 00-6.858-6.857 6.857 6.857 0 00-6.857 6.857 6.848 6.848 0 003.268 5.835" />
          </g>
        </g>
      </svg>
    },
    {
      ...
      paragraph: 'Simplify your payroll processes, manage employee data.',
      icon: <svg className="w-16 h-16 p-1 -mt-1 mb-2" viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg">
        <g fill="none" fillRule="evenodd">
          <rect className="fill-current text-violet-600" width="64" height="64" rx="32" />
          <g strokeWidth="2">
            <path className="stroke-current text-violet-300" d="M34.743 29.714L36.57 32 27.43 43.429H24M24 20.571h3.429l1.828 2.286" />
            ...
            <path className="stroke-current text-violet-300" d="M36.571 32H40" />
    ...
    },
    {
      ...
      paragraph: 'Promote employee well-being and productivity with tailored health programs.',
      icon: <svg className="w-16 h-16 p-1 -mt-1 mb-2" viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg">
        <g fill="none" fillRule="evenodd">
          <rect className="fill-current text-violet-600" width="64" height="64" rx="32" />
          <g strokeWidth="2">
            ...
            <path className="stroke-current text-violet-300" d="M21.714 40h4.572M24 37.714v4.572M37.714 24h4.572M40 21.714v4.572" strokeLinecap="square" />
          </g>
        </g>
      </svg>
    },
    {
      ...
      paragraph: 'Stay on top of regulations and minimize environmental impact with compliance audits.',
      icon: <svg className="w-16 h-16 p-1 -mt-1 mb-2" viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg">
        <g fill="none" fillRule="evenodd">
          <rect className="fill-current text-violet-600" width="64" height="64" rx="32" />
          <g strokeWidth="2">
            ...
            <path className="stroke-current text-violet-300" d="M32 19.429c6.943 0 12.571 5.628 12.571 12.571M32 24a8 8 0 018 8" />
    ...
    },
    {
      ...
      paragraph: 'Equip your workforce with essential skills through comprehensive training programs on safety.',
      icon: <svg className="w-16 h-16 p-1 -mt-1 mb-2" viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg">
        <g fill="none" fillRule="evenodd">
          <rect className="fill-current text-violet-600" width="64" height="64" rx="32" />
          <g strokeWidth="2" strokeLinecap="square">
            ...
            <path className="stroke-current text-violet-300" d="M44.571 43.429H34.286M44.571 37.714H34.286" />
          </g>
        </g>
      </svg>
    }
      ...
      <div className="relative max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20">
          ...
          <div className="max-w-sm mx-auto grid gap-6 md:grid-cols-2 lg:grid-cols-3 items-start md:max-w-2xl lg:max-w-none">
            ...
            {
              services.map(({ title, paragraph, icon }) => {
                return <OurServices title={title} paragraph={paragraph} icon={icon} />
              })
            }
